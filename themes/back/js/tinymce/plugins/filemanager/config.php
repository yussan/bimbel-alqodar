...
$base_url="http://".$_SERVER['SERVER_NAME'].str_replace("index.php","",$_SERVER['SCRIPT_NAME']); //url base of site if you want only relative url leave empty
$upload_dir = '/res/foto/galeri/'; // path from base_url to upload base dir
