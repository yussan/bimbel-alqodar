<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../gambar/berita/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../gambar/berita/'; // absolute or relative from this script path, required.
