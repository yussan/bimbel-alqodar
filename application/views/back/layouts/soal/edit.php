<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?= form_open('soal/update', array('id' => 'form-tambah', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
            <input name="id_soal" type="hidden" value="<?php echo $list['id_soal']; ?>"
            <div class="box-body">				        
				...
				<div class="form-group">
                    <label>Kategori Matapelajaran</label>
				...
				<div class="form-group">
                    <label>Soal</label>
                    <input class="form-control input-sm" name="soal" type="text" placeholder="Soal" value="<?php echo $list['soal']; ?>">
                </div>
            </div>		                   
