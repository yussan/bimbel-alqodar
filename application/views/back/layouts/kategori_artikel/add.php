<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?= form_open('kategori_artikel/save', array('role' => 'form', 'id' => 'form-tambah')); ?>
            <div class="box-body">				        
                <div class="form-group">
                    <label>Kategori Artikel</label>
                    <input id="kategori" class="form-control input-sm" name="kategori" type="text" placeholder="Nama Kategori Artikel">
                </div>
            </div>		                   
