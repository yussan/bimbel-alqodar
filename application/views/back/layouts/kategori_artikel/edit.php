<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?=
            form_open('kategori_artikel/update', array('id' => 'form-edit', 'role' => 'form'));
            if (!empty($list)) {
                foreach ($list as $row) {
                    ?>
                    <div class="box-body">				        
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control input-sm" name="kategori" type="text" value="<?= $row['KATEGORI'] ?>" placeholder="Nama Kategori Artikel">
                        </div>
                    </div>		                   
